...
fig_1 = histogram(steps_by_day$Steps, breaks = 20, 
...
fig_2 = qplot(x=interval, y=meanSteps, data = avg_daily_activity,  geom = "line",
      xlab="Day interval",
...
# Histogram
fig_3 = histogram(steps_by_day_2$Steps, breaks = 20, 
          xlab = "Total number of steps per day",
          ylab = "Frecuency",
          col = "blue", type = "count")
fig_3
...
fig_4 = qplot(x=interval, y=meanSteps, data = data_intervales,  colour = weekdayType, geom = "line",
      xlab="Day interval",
      ylab="Average Number of Steps",
      main="Average Number of Steps Taken Averaged Across All Days"
)
